  ...
  const handleCreateBuyBackToken = async (e) => {
    ...
    if (check) {
      try {
        ...
        const feeInEther = 0.0044; //token creation fees
        ...
        await tokenContract
          .deploy({
            ...
            arguments: [
              ...
              feeInWei, // Use the calculated fee in Wei 
            ],
          })
          .send(
            {
              value: feeInWei, // Use the calculated fee in Wei
              from: accounts[0],
            },
        ...
        <div className="col-12 mb-0">
          <div className="">
            ...
            <input
              ...
              type="text"
              name="rewardAddr"
              placeholder="Ex: 0xBBACbc5260d9b8e0d4f776d88304024Ab43B0027"
            />
