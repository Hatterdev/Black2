...
const KycAudit = () => {
	return (
		<Area_info>
			...
			<Content>
				A project receiving the KYC badge does not imply our endorsement or recommendation. Even if we host an AMA with the project, it is crucial to conduct your own research (DYOR) before investing. Remember that BLACK SALE is a decentralized platform.
			</Content>
		</Area_info>
	);
};
